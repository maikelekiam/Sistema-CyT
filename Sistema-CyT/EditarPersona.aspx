    ...
    <div class="container">
        ...
        <asp:Panel ID="Panel1" CssClass="panel panel-default" runat="server">
            ...
            <div class="form-group">
                <br />
                <asp:Label ID="lblPersonas" Font-Bold="true" runat="server" CssClass="col-md-2 AlineadoDerecha"> </asp:Label>
                <div class="col-md-6">
            ...
            <div class="form-group">
                <div class="col-md-2 col-md-offset-2">
                    <asp:Button ID="btnActualizarPersona" runat="server" Text="Actualizar" Width="180" CssClass="boton_verde" OnClick="btnActualizarPersona_Click" />
                </div>
            </div>
        </asp:Panel>
    </div>
