...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <asp:Panel ID="Panel1" CssClass="panel panel-default" runat="server">
        <div class="panel-heading">
            <h3>Formulario de ALTA Organismo</h3>
        </div>
        <!--NOMBRE-->
        <br />
        ...
        <div class="form-group">
            <div class="col-md-2 col-md-offset-2">
                <asp:Button ID="btnGuardarOrganismo" runat="server" Text="Guardar" CssClass="btn btn-success form-control" OnClick="btnGuardarOrganismo_Click" />
            </div>
        </div>
    </asp:Panel>
    ...
    <div class="form-group">
        <div class="col-md-9 col-md-offset-1">
            <asp:GridView ID="dgvOrganismo" runat="server" AutoGenerateColumns="false"
                ...
                OnRowCommand="dgvOrganismo_RowCommand">
                <Columns>
