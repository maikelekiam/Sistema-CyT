    ...
    <div class="container">
        <asp:Panel ID="Panel1" CssClass="panel panel-default" runat="server">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-xs-12">
                    <asp:TextBox ID="txtCorreoElectronico" runat="server" CssClass="form-control"></asp:TextBox><br />
                </div>
            </div>
            <!-- DOMICILIO -->
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-xs-12">
                    <asp:TextBox ID="txtObservaciones" runat="server" CssClass="form-control" TextMode="MultiLine" Rows="2"></asp:TextBox><br />
                </div>
            </div>
        </asp:Panel>
    </div>
