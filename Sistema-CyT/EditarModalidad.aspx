    ...
    <div class="container">
        <asp:Panel ID="PanelSuperior" CssClass="panel panel-info" runat="server">
            <div class="panel-heading">
                <h3>Formulario EDITAR Modalidad</h3>
            </div>
            ...
            <div class="modal-footer">
                <asp:Button runat="server" ID="btnModalModalidadSalir" Text="SALIR" class="btn btn-danger" OnClick="btnModalModalidadSalir_Click" />
                <asp:Button runat="server" ID="btnModalModalidadActualizar" Text="ACTUALIZAR" CssClass="btn btn-success" OnClick="btnModalModalidadActualizar_Click" />
            </div>
